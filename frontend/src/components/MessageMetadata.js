...
function MessageMetadata({metadata}) {
    ...
    return (
        <div className="message-metadata-container">
            ...
            {/* Temporary debug to see what metadata we're getting */}
                                            ...
                                            {(step.tokens?.total > 0 || step.tool_calls_count > 0 || step.message_type) && (
                                                <div className="agent-item-details">
                                                    {step.tokens && step.tokens.total > 0 && (
                                                        <span className="step-detail">{step.tokens.total}t</span>
                                                    )}
                                                    {step.tool_calls_count > 0 && (
                                                        <span className="step-detail">{step.tool_calls_count}tc</span>
                                                    )}
                                                    {step.message_type && (
